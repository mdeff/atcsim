...
// It contains only pure virtual (abstract) methods and a virtual destructor (important).

class IEntity {
  
public:

  // Virtual destructor to avoid undefined behaviours if someone tries to delete an object of type IEntity.
